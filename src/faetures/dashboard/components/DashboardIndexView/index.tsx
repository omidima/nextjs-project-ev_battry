        ...
        {vehicle.active ? <div className={s.body}>
            ...
            <Grid item xl={6} lg={6} md={12} sm={12} xs={12}>
                <div className={`${s.card} ${s.simple}`}>
                    <h3>Real Max Range (Miles)</h3>
                    <p>The estimated maximum distance the vehicle can travel on a full charge in real-world driving conditions.</p>
            ...
            <Grid item xl={6} lg={6} md={12} sm={12} xs={12} paddingBottom={10}>
                <div className={`${s.card} ${s.simple}`}>
                    <h3>Real Battery Efficiency (Wh/mi)</h3>
                    <p>The energy consumption rate of the vehicle measured in watt-hours per mile.</p>
